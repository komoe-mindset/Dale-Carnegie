...
export const ApplicationOverview: React.FC<ApplicationOverviewProps> = ({
  ...
  > = {
    business: {
      ...
      keyPrinciples: [
        'အမှားကို လူရှေ့တွင် မဆူပူဘဲ လုပ်ငန်းစဉ် အခက်အခဲကို အတူရှာဖွေပါ',
        'အစည်းအဝေးများတွင် တစ်ဖက်သား၏ အကြံပြုချက်ကို လေးစားစွာ နားထောင်ပါ',
    ...
    sales: {
      ...
      bgLight: '#FBECE7',
      borderColor: '#F3CFC4',
      description: 'ကုန်ပစ္စည်းကို အတင်းအကျပ် ရောင်းချမည့်အစား Customer ကြုံနေရတဲ့ အခက်အခဲနှင့် လိုအပ်ချက်ကို စာနာနားလည်ကာ ယုံကြည်စိတ်ချရသော မိတ်ဖက်အဖြစ် ရပ်တည်ခြင်း။',
      keyPrinciples: [
      ...
      practicalAdvice: 'လူတွေဟာ အတင်းရောင်းတာကို မကြိုက်ကြပါ၊ ကိုယ်တိုင်ရွေးချယ်ဝယ်ယူရတာကိုပဲ သဘောကျကြသည်။',
      quote: 'အရောင်းသမားကောင်းသည် ကုန်ပစ္စည်းကို အတင်းမရောင်းဘဲ Customer အတွက် အကောင်းဆုံးအဖြေကို ရှာဖွေပေးသူဖြစ်သည်။',
    },
    teaching: {
      label: 'Teaching',
      ...
      quote: 'ပညာသင်ကြားခြင်းဆိုသည်မှာ ပုံးအလွတ်ထဲသို့ ရေဖြည့်ခြင်းမဟုတ်ဘဲ စိတ်အားထက်သန်မှု မီးတောက်ကို မွေးမြူပေးခြင်းဖြစ်သည်။',
    },
    leadership: {
      label: 'Leadership',
